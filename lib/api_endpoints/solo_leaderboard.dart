...
class APISoloLeaderboard {
  ...
  fetch({server = 'euw1'}) async {
    try {
      ...
      var response = await getAPI(
        'league-exp/v4/entries/RANKED_SOLO_5x5/CHALLENGER/I?page=1&',
        server: server,
      );
  ...
  List<dynamic> getSoloLeaderboard() {
    return _soloLeaderboard;
  }
}
